    ...
    return (
        <div className="container">
            ...
            <form onSubmit={validarInput}>
                ...
                <div className="mb-3">
                    <label htmlFor="passwordConfirm" className="form-label">Confirmar Password</label>
                    <input type="password" className="form-control" id="passwordConfirm" name="PasswordConfirm" onChange={(e) => setPasswordConfirm(e.target.value)} />
                </div>
